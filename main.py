...
#This is a Pydantic model that inherits from BaseModel and defines a schema
...
def about():
    return {
        "message":"A functional API to manage your patient records"
    }
...
def update_patient(patient_id: str, patient_update: PatientUpdate):
    ...
    updated_info=patient_update.model_dump(exclude_unset=True) # pydantic model to dict
